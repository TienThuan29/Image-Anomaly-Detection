...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        # Load resnet18
        # pretrained=True: use weight, pretrained=False: no use weight
...
class ResNetDecoder(nn.Module):
    def __init__(
        ...
        # Chuỗi upsampling để đi từ 8→16→32→64→128→256
        ...
        # Khởi tạo conv theo Kaiming để ổn định hơn
...
class UpBlock(nn.Module):
    def __init__(self, in_c: int, out_c: int, groups: int = 8, dropout_p: float = 0.0):
        super().__init__()
