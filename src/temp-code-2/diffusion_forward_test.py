...
# #     # Model/ckpt
# #     p.add_argument("--ckpt", type=str, required=True, help="Path to pretrained VAE checkpoint (.pth)")
# #     p.add_argument("--in_channels", type=int, default=3)
# #     p.add_argument("--latent_dim", type=int, default=256)
# #     p.add_argument("--out_channels", type=int, default=3)
# #     # Data source
# #     p.add_argument("--img_dir", type=str, default=None, help="If set, load x0 from this folder")
# #     p.add_argument("--max_images", type=int, default=8)
# #     p.add_argument("--image_size", type=int, default=256)
# #     p.add_argument("--use_samples", action="store_true", help="If set (and no img_dir), sample x0 from VAE latent")
# #     # Diffusion
...
# #     p.add_argument("--sample_ts", type=int, nargs="+", default=[0, 50, 100, 250, 500, 750, 999])
# #     # Misc
# #     p.add_argument("--device", type=str, default="cuda" if torch.cuda.is_available() else "cpu")
# #     p.add_argument("--seed", type=int, default=42)
# #     p.add_argument("--out_dir", type=str, default="./diffusion_forward_vis")
# #     return p.parse_args()
#
# def set_seed(seed: int):
#     import random
...
#     #     x0, _ = load_images_from_dir(img_dir, diffusion_config.get("image_size"), max_images=10)
#     # else:
#     #     # Lấy ảnh từ latent random nếu --use_samples, ngược lại báo lỗi
#     #     if args.use_samples:
#     #         x0 = model.sample(num_samples=args.max_images, device=device).cpu()
#     #     else:
#     #         raise ValueError("Bạn cần cung cấp --img_dir hoặc dùng --use_samples để tạo x0 từ VAE.")
#
#     diffusion = GaussianDiffusion(
#         num_timesteps=diffusion_config.get("num_timesteps"),
#         beta_schedule=diffusion_config.get("beta_schedule")
