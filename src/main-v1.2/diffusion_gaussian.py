...
class GaussianDiffusion:
    ...
    def get_alpha_cumprod(self, t: torch.Tensor) -> torch.Tensor:
        """Get alpha_cumprod values at timesteps t"""
        return self._extract(self.alphas_cumprod, t, t.shape + (1, 1, 1))
    ...
    # def predict_start_from_noise(self, x_t: torch.Tensor, t: torch.Tensor, noise_pred: torch.Tensor) -> torch.Tensor:
